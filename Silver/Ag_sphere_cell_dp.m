% Ag-Nanosphere cellular
% 007 Sloot & Drain 010 Nanosphere
clear
tic
% Simulating Sphere Nanoparticle ==========================================
[rv,N,d0]=geometrySphere(50e-9,10);    %# radius determine here
%==========================================================================
step=5;                                                 %# landa step 
landa=(301:step:460)*1e-9;  K=2*pi./landa;           
mm=Ag_nk_siz;
m=mm(4,101:step:260)+i*mm(9,101:step:260);              
% =========================================================================
...
dz = repmat(rv(:,3), 1, N) - repmat(rv(:,3).', N, 1);nd=sqrt(dx.^2+dy.^2+dz.^2);                     %# Norm of rv vectors
